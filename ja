...
## ダウンロード
  ...
  * **[✅️ Windows版: バージョン1.03をダウンロード (exe)](https://github.com/exis9/Nyan-FA/releases/download/v1.03\(Windows\)/Nyan-FA.1.0.3.exe)**
  * **[✅️ Mac版: バージョン1.03をダウンロード (dmg)](https://github.com/exis9/Nyan-FA/releases/download/v1.03\(Mac\)/Nyan-FA-1.0.3.dmg)**
...
Appleに毎年99ドルの開発者費用を支払っていないため、Macでは不要なセキュリティ許可を与えないとこのアプリを起動できません。

セキュリティ警告が表示されてアプリを起動できない場合は、以下の簡単な手順に従ってください。

インストール後、アプリを起動してください。セキュリティ警告が表示されて起動できない場合は、以下の手順を実行してください。
（この操作は初回のみ必要です。次回からはAppleが邪魔することはありません。）
